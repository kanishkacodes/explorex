  ...
  return (
    <div className="h-[40rem] flex items-center justify-center   bg-gradient-to-tr from-[#44065a] to-[#120119]">
      <div className="text-center">
        ...
        <button className="py-4 px-14 bg-white font-bold text-black md:text-2xl text-xl hover:border-2 hover:border-t-red-400 hover:border-orange-500   rounded-lg  tracking-wide hover:bg-black hover:text-white">Request A Demo</button>
      </div>
    </div>
  );
}
