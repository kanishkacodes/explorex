    ...
    <div>
      <div className=''>
        ...
        <div className=' h-screen bg-red-500 hover:bg-red-800'>
          ...
          <h1 className="font-bold md:text-5xl text-3xl flex justify-center items-center md:mb-10 mb-9  text-white">Website Design</h1>
          <p className="md:text-2xl text-xl tracking-wide font-medium flex justify-center items-center md:mb-10 mb-9 text-white text-center ">Effective websites to enhance your business</p>
