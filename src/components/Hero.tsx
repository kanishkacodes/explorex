  ...
  return (
    <div>
      <div className="lg:flex justify-center space-x-6 ">
        ...
        >
          <h1 className="font-bold tracking-wide text-5xl lg:text-7xl text-black mt-0 lg:mt-28">
            Design
          </h1>
          <h1 className="font-bold tracking-wide text-5xl lg:text-7xl text-black">
            Transform
          </h1>
          <h1 className="font-bold tracking-wide text-5xl lg:text-7xl text-black">
            Accelerate
