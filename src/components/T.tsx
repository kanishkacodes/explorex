...
const T: React.FC = () => {
  ...
  const textElements = [
    "Web Design", "Softwares", "Mobile Apps", "Menu Engineering", "Customer Data-Analysis"
  ];
  return (
    <div ref={ref} className="md:flex items-center">
      ...
      >
        <div className="md:w-16 md:h-16 w-12 h-12 rounded-full bg-blue-500 ml-5 md:ml-0"></div>
        <div>
          <h1 className="font-bold text-5xl md:text-7xl text-black mb-8">Technology</h1>
